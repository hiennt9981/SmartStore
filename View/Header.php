...
<html lang="en">
  ...
  <body>
    <div class="header-area" style="background-color: rgba(32,178,170);">
        <div class="container">
            <div class="row" style="background-color: rgba(32,178,170);">
                <div class="col-md-8" style="background-color: rgba(32,178,170);">
                    <div class="user-menu" style="background-color: (32,178,170);">
                        <ul style="background-color: rgba(32,178,170);">
...
EOD;
    ...
    <div class="mainmenu-area" style="background-color: rgba(0,206,209);">
        <div class="container">
            <div  class="row">
                ...
                <div style="background-color:  rgba(0,206,209); font-weight: bolder;"class="navbar-collapse collapse">
                    <ul type="disc" class="nav navbar-nav">
                        <li><a style="color: #FFFFFF; font-family: logo ;font-size:35px;background-color: rgba(0,206,209)"  href="index.php">SmartStore</a></li>
                        <li>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content" style="z-index : 50">
