<br>
<center><h2 class="section-title" style="background-color: rgba(32,178,170)">Chi Tiết Sản Phẩm</h2></center>
                                ...
                                <div class="product-inner">
                                    ...
                                    <div role="tabpanel">
                                        <ul class="product-tab" role="tablist">
                                            <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab" style="background-color: rgba(32,178,170)">Mô tả</a></li>
                                            <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab" style="background-color: rgba(32,178,170)">Thông tin chi tiết</a></li>
                                        </ul>
