<br>
<center><h2 class="section-title" style="background-color:  rgba(32,178,170);">Kết quả tìm kiếm</h2></center>
<!-- <div class="main-ver2"> -->
							...
							<p style="color: #5A88CA;font-size: 16px; font-weight:bold;">Giá: $pr VND</p>
								<div class="button">
									<a href="index.php?mod=products&act=detail&id={$row['ProductID']}">
										<button type="button" class="btn btn-info" style="background-color:rgba(32,178,170); border:none">CHI TIẾT</button>
									</a>
									<a href="Controller/Cart/Add.php?id={$row['ProductID']}"  onclick="return insertCart({$row['ProductID']})">
										<button type="button" class="btn btn-info" style="background-color: rgba(32,178,170); border:none">THÊM <i  class="fa fa-shopping-cart"> </i></button>
									</a>
