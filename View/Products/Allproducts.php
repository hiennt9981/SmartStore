<br>
<center><h2 class="section-title" style="background-color: rgba(32,178,170)">Tất cả sản phẩm</h2></center>
<br>
<center>
  <form method="post" action="index.php?mod=products&act=allproducts">
    ...
    <button type="submit" name="btnOK" style="font-size: 15px; background-color: rgba(32,178,170); border-radius: 10px; margin-left: 5px">Ok</button>
    </form>
</center>
<br>
<div class="main-ver2">
